...
if ($_SERVER['REQUEST_METHOD'] != 'POST' && isset($conexao_banco)) {
    mysqli_close($conexao_banco);
}
?>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <p class="text-primary">Fazer postagem</p>
                ...
                <tr>
                    ...
                    <td>
                        <select name="materia" required>
                            ...
                            <?php
                                if (isset($resultado_materias) && mysqli_num_rows($resultado_materias) > 0) {
